...
class RakitSenjata:
    ...
    def jalankan(self, robot, gerak, target_angle, target_jarak):
        ...
        if self.state == "TRANSISI":
        ...
        elif self.state == "GESER_KESAMPING":
            gerak.base_speed = 35 # Kecepatan pelan
            gerak.max_pwm = 45
            ...
            gerak.stop(robot)
            if (now - self.start_time > 0.5): # Delay sejenak sebelum selesai
